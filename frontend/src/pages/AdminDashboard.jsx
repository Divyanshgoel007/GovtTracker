    ...
    <main className="min-h-screen pb-8">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard icon={Users} label="Passengers" value={stats.studentCount} color="amber" />
        ...
        <section className="card p-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <QuickLink to="/admin/students" icon={Users} label="Manage Passengers" />
            <QuickLink to="/admin/assignments" icon={MapPin} label="Passenger Routes" />
          </div>
