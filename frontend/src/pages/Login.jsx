...
const Login = () => {
  ...
  const targetPath = useMemo(() => {
    ...
    if (user.role === 'student' || user.role === 'passenger') return '/student';
    return '/login';
  }, [user]);
        ...
        <div className="login-card login-card-animate">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="login-field">
              ...
              <input
                type="text"
                placeholder="Enter Passenger ID or username"
          ...
          <p className="login-footer-hint mt-6">
            ...
            <Link to="/register" className="text-orange-500 hover:text-orange-600 transition-colors font-medium">
              Sign up here
            </Link>
          </p>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4" onClick={closeForgotPassword}>
          ...
          >
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              <div className="login-field">
                <label className="login-label">Passenger ID or Email</label>
                <input
                  type="text"
                  placeholder="Enter your Passenger ID or email"
                  className="login-input"
